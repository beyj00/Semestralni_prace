...
public class GamePlan
{
    ...
    private void prepareWorldMap()
    {
        ...
        Item povoz = new Item("povoz", "Dřevěný povoz pro převoz sena.", false);
        Item lopata = new Item("lopata", "Železná lopata s naprasklou násadou.");
        Item sekera = new Item("sekera", "Válečná sekera.");
        Item lod = new Item("lod", "Nová loď kterou ses s Flokim rozhodl postavit. Pro její dokončení je potřeba kotva.", false);
        Item chleb = new Item("chleb", "Čerstvě upečený chléb.");
        Item pivo = new Item("pivo", "Tmavé a velmi silné pivo.");
        Item stul = new Item("stul", "masivní stůl z dubového dřeva.", false);
        Item stanek = new Item("stanek", "malý stánek s pečivem.", false);
        ...
        Item sin = new Item("sin", "Příbytek jarla Kattegatu. Konají se zde veškerá zasedání a oslavy.", false);
